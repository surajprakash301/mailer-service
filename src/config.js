...
export const config = {
  ...
  gatherIndustries: Number(process.env.GATHER_INDUSTRIES) || 16,
  gatherCompaniesPerIndustry: Number(process.env.GATHER_COMPANIES_PER_INDUSTRY) || 4,
  ...
  /** Optional Places Text Search + Details for geofenced Patna retrieval */
